...
router.post("/:cuisineName", async (req, res) => {
  ...
  const url = `https://api.spoonacular.com/recipes/complexSearch?apiKey=${process.env.API_KEY2}&cuisine=${cuisineName}&number=2`;
...
//   const url = `https://api.spoonacular.com/recipes/complexSearch?apiKey=${process.env.API_KEY2}&cuisine=${cuisineName}&number=100`;
//   const response = await fetch(url);
//   const result = await response.json();
//   const recipes = result.results;
